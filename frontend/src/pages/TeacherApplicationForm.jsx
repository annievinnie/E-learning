...
const TeacherApplicationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const backendUrl = '${process.env.REACT_APP_API_URL}/api/teacher/apply';
      ...
      if (err.response) {
        ...
        errorMessage = 'Network error: Could not connect to the server. Please make sure the backend server is running on ${process.env.REACT_APP_API_URL}';
      } else {
